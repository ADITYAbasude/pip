...
//```````````````````````id declaration```````````````````````````````````````
    ...
    private void setImage() {
        firebaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    Glide.with(EditUserProfileScreen.this).load(take_uri).into(setImageOfUser);
                }
            }
        ...
        firebaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    setImageOfUser.setImageResource(R.drawable.usermodel);
                }
            }
    ...
    private void takeUserDataFromDataBase() {
        FirebaseDatabase.getInstance().getReference("user").child("UserInfo").child(userInfo).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                UserName.setText(String.valueOf(getUserModelData.usName));
            }
        ...
        FirebaseDatabase.getInstance().getReference("user").child("UserInfo").child(userInfo).child("EditedData").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    UserModel userModel = snapshot.getValue(UserModel.class);
                    UserBio.setText(userModel.Bio);
                    UserLocation.setText(String.valueOf(userModel.Location));
                    UserWebsite.setText(String.valueOf(userModel.Website));
                    datePicker.setText(String.valueOf(userModel.dateOfBirth));
                }
            }
